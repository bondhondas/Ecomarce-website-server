...
async function run() {
    try {
        ...
        const database = client.db("luxurySuiteDatabase");
        ...
        const jobApplicationCollection = database.collection("jobApplicationCollection");
...
app.get('/', (req, res) => {
    res.send("Luxury Suite Server Running");
});
